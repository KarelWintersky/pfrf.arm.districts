...
convertDateToArray()
convertUserDateToSQLDate()
redirect()
isAjaxCall()
retVal()


@see http://manual.phpdoc.org/HTMLSmartyConverter/HandS/phpDocumentor/tutorial_tags.pkg.html
*/
...
by http://www.manhunter.ru/webmaster/39_proverka_prinadlezhnosti_ip_adresa_zadannomu_diapazonu.html
*/
...
{
    $r = 0;
    if (($r = ip2long( $ip )) < 0){ $r += 4294967296 ;}
    return $r;
}
