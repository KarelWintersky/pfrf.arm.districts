...
/* формирует SELECTOR/OPTIONS list с текущим элементом равным [chosen_value]
 ...
 *                           }
 * chosen_value    =       false или значение (value) опции, которую мы выбираем после
 ...
 *
 * */
function BuildSelector(target_name, selector_data, default_option, chosen_value )
{
    /*
      */
    ...
    if (data['error'] == 0) {
        ...
        if (chosen_value !== false) Selector_SetOption(target_name, curr_id);
